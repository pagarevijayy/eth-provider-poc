...
import { BackgroundScriptUpdateHandler } from '../eip-eth-provider/shared/BackgroundScriptUpdateHandler';
import { PortMessageChannel } from '../eip-eth-provider/shared/PortMessageChannel';
...
const port = new PortMessageChannel({
    name: `${chrome.runtime.id}/ethereum`,
});
...
script.setAttribute('id', 'komet-extension-channel');
