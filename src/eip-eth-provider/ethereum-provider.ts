...
import { formatJsonRpcRequestPatched } from './shared/custom-rpc/formatJsonRpcRequestPatched';
import { InvalidParams, MethodNotImplemented } from './shared/errors';
import type { Connection } from './connection';

// import { WalletNameFlag } from './shared/types/WalletNameFlag';
enum WalletNameFlag {
...
export class EthereumProvider extends JsonRpcProvider {
    ...
    send = (payload: unknown, callback: unknown) => {
        ...
        if (typeof payload === 'object' && typeof callback === 'function') {
            // @ts-expect-error callback should have appropriate signature
